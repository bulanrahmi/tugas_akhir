            ...
            <div id="left-menu">
                <div class="sub-left-menu scroll">
                    <ul class="nav nav-list">
                        ...
                        <li class="time">
                            <h1 class="animated fadeInLeft">08:00</h1>
                            <p class="animated fadeInRight">Sat,Mei 21 2021</p>
                        </li>
                        ...
                        <?php endif; ?>
                        <li class="ripple"><a href="<?php echo site_url('Pendaftaran') ?>"><span class="fa fa-user icon-sign-out"></span>Pendaftaran</a></li>
